...
def etl(event, context):
    ...
    client = storage.Client(project="My Project 89113 TEST")  
    destination_bucket_name = 'pf_cleaned_data' 
    ...
    #FILTRADO Y LIMPIEZA DE REVIEWS
        ...
        client = bigquery.Client(project="My Project 89113 TEST")
        sql_query = ('''SELECT *
                FROM my-project-89113-test.datawarehouse.reviews_yelp
                ''')
        ...
        #Filtro por estado PGREGUNTAR ESTADOS
        #Se guardan en una lista los estados seleccionados
        estados = ['PA', 'FL']
        ...
        if 'Pennsylvania' in source_file_name:
            state = 'PA'
